...
filepaths_list = [os.path.join(current_dir, file) for file in os.listdir(current_dir) if file.endswith(".txt") and "nA" in file]
...
fig.tight_layout()
fig.savefig('Calibration11162023'+'.png', dpi=500)
